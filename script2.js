...
// Latihan condinational statement
const userInput = promp("Masukkan Nilai anda?");

const checkValue = +userInput; // melakukan konversi ke interger atau number

if (isNaN(checkValue)) alert("Harap memasukkan angka"); // validasi jika value adalah number

if (checkValue < 0 || checkValue > 100) alert("Harap memasukkan angka diantara 1 - 100!"); // jika value diantara 1 - 100
...
if (checkValue >= 80 && checkValue <= 100) alert("D");
